...
export class CountryCallCodesService {
    ...
    private countryList: Country[] = [
        ...
        {country: "Antigua & Barbuda", code: "+1"},
        ...
        {country: "St Bathélemy", code: "+590"},
        {country: "St Helena", code: "+290"},
        {country: "St Kitts & Nevis", code: "+1"},
        {country: "St Lucia", code: "+1"},
        {country: "St Martin", code: "+590"},
        {country: "St Pierre & Miquelon", code: "+508"},
        {country: "St Vincent & Grenadines", code: "+1"},
        ...
        {country: "Trinidad & Tobago",  code:"+1"  },
        {country: "Tunisia", code: "+216"},
        {country: "Turkey" , code: "+90"},
        {country: "Turkmenistan", code: "+993"},
        {country: "Turks & Caicos Islands" , code: "+1"},
        ...
        {country: "Wallis & Futuna Islands" , code: "+681"},
